...
const EVENT_BADGE_COLORS: Record<UniversityEventType, string> = {
  ...
  response_received: 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300',
  ...
  other: 'bg-surface-100 text-surface-600 dark:bg-surface-800 dark:text-surface-300',
}
